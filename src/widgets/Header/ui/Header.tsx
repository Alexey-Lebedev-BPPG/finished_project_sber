		...
		<header className={cls.header}>
			<div className={classNames('container', cls['header-wrapper'])}>
				...
				<div className={cls['header-icons-menu']}>
					<Link className={cls['header-favorites-link']} to='/favorites'>
						<svg
							viewBox='0 0 24 24'
							fill='none'
					...
					<Link className={cls['header-favorites-link']} to='/cart'>
						<svg
							width='24'
							height='24'
							viewBox='0 0 24 24'
					...
					{accessToken && (
						<>
							<Link className={cls['header-icons-menu-item']} to='/profile'>
								<svg
							...
							<Link className={cls['header-icons-menu-item']} to={'/signin'}>
								Выйти
							</Link>
						</>
					)}
